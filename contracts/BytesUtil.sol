...
pragma solidity >=0.7.0 <0.8.0-0||>=0.8.0 <0.9.0-0;

/// @title BytesUtil

abstract contract BytesUtil {
    // @dev Based on stack overflow here:
    ...
    // @dev find something faster than this.
    // via stack overflow:
    ...
    // @note Starting point was this, but with some modifications.
    ...
    // @note From https://github.com/GNSPS/solidity-bytes-utils/blob/master/contracts/BytesLib.sol
    function sliceAsm(
        bytes memory _bytes,
        uint256 _start,
        uint256 _length
    ...
    // @note https://ethereum.stackexchange.com/questions/78559/how-can-i-slice-bytes-strings-and-arrays-in-solidity
    function slice(
        bytes memory _bytes,
        uint256 _start,
        uint256 _length
